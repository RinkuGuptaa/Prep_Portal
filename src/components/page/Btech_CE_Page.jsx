// src/components/Btech_CE_Page.js
import React, { useState, useEffect } from 'react';
import { Link as RouterLink, useNavigate } from 'react-router-dom'; // Use RouterLink
...
const Btech_CE_Page = () => {
  ...
  // Update these links with the correct Google Drive URLs for Civil Engineering
  const semesterCardData = [
    ...
    { title: "3rd Semester", Link: "https://drive.google.com/drive/folders/12csG9fKIagpwactJ7L-37MHkS9DQbnPR?usp=drive_link" },
    { title: "4th Semester", Link: "https://drive.google.com/drive/folders/12dBpek9qj8Jdd8p9uD7AfkJ0ry-1lEVy?usp=drive_link" },
    { title: "5th Semester", Link: "https://drive.google.com/drive/folders/12e5JpJ8iue8PlRIA4cUbK-FfvrM54Fv0?usp=drive_link" },
    { title: "6th Semester", Link: "https://drive.google.com/drive/folders/12f-WSuyprgu0_Zh8JAXcUlMSLyzPnKwk?usp=drive_link" },
    { title: "7th Semester", Link: "https://drive.google.com/drive/folders/12fB-0seV9R-KrGPnxSoUUnoz_2yqPH7n?usp=drive_link" },
    { title: "8th Semester", Link: "https://drive.google.com/drive/folders/12fP0mdrJpwyEgpch1XuuUua0AV9NK4ur?usp=drive_link" },
  ];
  ...
  return (
    <div className={`btech-page-container ${darkMode ? 'dark-mode-component' : ''}`}>
      ...
      {/* Main Content for B.Tech Civil Engineering Semesters */}
      <div className={`container mt-5 main-content-custom ${sidebarOpen ? 'sidebar-open-push-effect' : ''}`}>
        <div className="row">
          <div className="col-12 text-center">
            <h2 className={`heading-custom ${darkMode ? 'text-white' : 'text-dark'}`}>
              Civil Engineering Previous-years Question-Papers
            </h2>
          </div>
        </div>
        ...
        <div className="row justify-content-center">
          {semesterCardData.map((sem, index) => (
            // For 8 items, col-lg-3 might be better for 4 cards per row on large screens
