// src/components/Btech_ME_Page.js
...
const Btech_ME_Page = () => {
  ...
  // IMPORTANT: Update these links with the correct Google Drive URLs for ME
  const semesterCardData = [
    ...
    { title: "3rd Semester", Link: "https://drive.google.com/drive/folders/141Qy4KOL6L0BZcoLHD2HVSH_eXe809MU?usp=drive_link" },
    { title: "4th Semester", Link: "https://drive.google.com/drive/folders/148KHntx09NASzGVSaTJBa_b4jluAZQ5o?usp=drive_link" },
    { title: "5th Semester", Link: "https://drive.google.com/drive/folders/149lxbXXx7O8gbZYoUfay1d6V301sEkzt?usp=drive_link" },
    { title: "6th Semester", Link: "https://drive.google.com/drive/folders/14C8gUhStlyGeekk6wDkkGF_Yhufxj5wT?usp=drive_link" },
    { title: "7th Semester", Link: "https://drive.google.com/drive/folders/14F9E420OVP2A9PdR5mknhynyLlJM1-y3?usp=drive_link" },
    { title: "8th Semester", Link: "https://drive.google.com/drive/folders/14GKmssjPxLsExHXcUVuD5aqSqoRz39oE?usp=drive_link" },
  ];
  ...
  return (
    <div className={`btech-page-container ${darkMode ? 'dark-mode-component' : ''}`}>
      ...
      {/* Main Content for B.Tech Mechanical Engineering Semesters */}
        ...
        <div className="row">
          <div className="col-12 text-center">
            <h2 className={`heading-custom ${darkMode ? 'text-white' : 'text-dark'}`}>
              Mechanical Engineering Previous-years Question-Papers
            </h2>
          </div>
        </div>
