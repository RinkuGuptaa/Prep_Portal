...
const Btech_CSE_Page = () => {
  ...
  // IMPORTANT: Update these links with the correct Google Drive URLs for CSE
  const semesterCardData = [
    ...
    { title: "3rd Semester", Link: "https://drive.google.com/drive/folders/12i0Ncfep-cxddLLMTQ7sBpVEzDUAIX0I?usp=drive_link" },
    { title: "4th Semester", Link: "https://drive.google.com/drive/folders/12i89cOg7pkmTwxqbToCbqcLuXAHmSvZB?usp=drive_link" },
    { title: "5th Semester", Link: "https://drive.google.com/drive/folders/12koCpnoEVV2V1rvUyKm9avsSCItSvadB?usp=drive_link" },
    { title: "6th Semester", Link: "https://drive.google.com/drive/folders/12luGQGCqL4ULIUssjaVIGxW3f729dPiG?usp=drive_link" },
    { title: "7th Semester", Link: "https://drive.google.com/drive/folders/12ubsxCgK1wGrq50vpxU-hIrfVXKiMMmE?usp=drive_link" },
    { title: "8th Semester", Link: "https://drive.google.com/drive/folders/12ySp_dR4fT1pFuy0oeVKr50f0j3nzu4I?usp=drive_link" },
  ];
  ...
  return (
    <div className={`btech-page-container ${darkMode ? 'dark-mode-component' : ''}`}>
      ...
      {/* Main Content for B.Tech Computer Science and Engineering Semesters */}
        ...
        <div className="row">
          <div className="col-12 text-center">
            <h2 className={`heading-custom ${darkMode ? 'text-white' : 'text-dark'}`}>
              Computer Science and Engineering Previous-years Question-Papers
            </h2>
          </div>
        </div>
