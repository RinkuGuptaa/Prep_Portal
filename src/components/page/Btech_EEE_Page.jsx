...
const Btech_EEE_Page = () => {
  ...
  // IMPORTANT: Update these links with the correct Google Drive URLs for EEE
  const semesterCardData = [
    ...
    { title: "3rd Semester", Link: "https://drive.google.com/drive/folders/130p6VD9CF8dnHuZaMuKctpK-U2UgBIL-?usp=drive_link" },
    { title: "4th Semester", Link: "https://drive.google.com/drive/folders/137-PHjU030JLSZuWSYl8uTPKfVDhmatU?usp=drive_link" },
    { title: "5th Semester", Link: "https://drive.google.com/drive/folders/13EQTvTaXqV1H0RS45MvKAA6jToFRVbcJ?usp=drive_link" },
    { title: "6th Semester", Link: "https://drive.google.com/drive/folders/13Fn_2dG5Ux8y5Fggisc2VjUpkHgis3OP?usp=drive_link" },
    { title: "7th Semester", Link: "https://drive.google.com/drive/folders/13Gb107pitt-qYJ4zQ61_E0DNXnTxlIYl?usp=drive_link" },
    { title: "8th Semester", Link: "https://drive.google.com/drive/folders/13JgYHohPM6pfkCwwVQ2V8PzcWoufBrJn?usp=drive_link" },
  ];
  ...
  return (
    <div className={`btech-page-container ${darkMode ? 'dark-mode-component' : ''}`}>
      ...
      {/* Main Content for B.Tech Electrical and Electronic Engineering Semesters */}
        ...
        <div className="row">
          <div className="col-12 text-center">
            <h2 className={`heading-custom ${darkMode ? 'text-white' : 'text-dark'}`}>
              Electrical and Electronic Engineering Previous-years Question-Papers
            </h2>
          </div>
        </div>
